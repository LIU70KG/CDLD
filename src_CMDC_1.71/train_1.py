...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--n_epoch', type=int, default=200)  # sota 500
    parser.add_argument('--patience', type=int, default=80)  # sota 100
    ...
    parser.add_argument('--class_weight', type=float, default=15.0)
