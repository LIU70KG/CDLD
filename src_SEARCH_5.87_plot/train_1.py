...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--patience', type=int, default=80)  # sota 80
    ...
    parser.add_argument('--class_weight', type=float, default=20.0)
    parser.add_argument('--shifting_weight', type=float, default=3.0)
    ...
    # parser.add_argument('--max_shift', type=float, default=10)
    # parser.add_argument('--test_mae_history_path', type=str, default='./test_mae_history_standards.txt')

    # # Scale standards1---good
    # parser.add_argument('--interval_Scale', type=str, default='standards')
    # parser.add_argument('--interval_num', type=int, default=5)
    # parser.add_argument('--center_score', type=parse_list, default=[5, 11, 17, 24, 36])
    # parser.add_argument('--min_shift', type=float, default=-8.0)
    # parser.add_argument('--max_shift', type=float, default=8)
    # parser.add_argument('--test_mae_history_path', type=str, default='./test_mae_history_standards.txt')

    # Scale average
    parser.add_argument('--interval_Scale', type=str, default='average')
    parser.add_argument('--interval_num', type=int, default=5)
    parser.add_argument('--center_score', type=list, default=[4, 14, 23, 32, 41])
    parser.add_argument('--min_shift', type=float, default=-4.0)
    ...
    # Data
    parser.add_argument('--data', type=str, default='./SEARCH/SEARCH_data_')
