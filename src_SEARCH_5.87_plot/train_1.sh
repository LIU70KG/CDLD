...
model_choice=('MISA_CMDC')
class_weight_choice=(30.0 20.0 15.0 10.0 5.0)
shifting_weight_choice=(2.0 1.5 1.0)
order_center_weight_choice=(2.0 1.0)
ce_loss_weight_choice=(3.0 2.0 1.0)
...
model_choice=('Simple_Fusion_Network')
class_weight_choice=(5.0 3.0 2.0 1.0)
shifting_weight_choice=(2.0 1.5 1.0)
order_center_weight_choice=(2.0 1.0)
ce_loss_weight_choice=(3.0 2.0 1.0)
#pred_center_score_weight_choice=(0.0 0.05 0.1)
