...
class CubeMLP(nn.Module):
    def __init__(self, config, seq_len=8, num_modalities=3, hidden_dim=128, last_seq=3, last_cannel=10):
        super().__init__()
        self.seq_len = seq_len
        self.num_modalities = num_modalities
        ...
        # 3层 CubeMLP block
        self.block1 = CubeMLPBlock(12, seq_len, 128, 64, num_modalities)
        self.block2 = CubeMLPBlock(seq_len, 6, 64, 32, num_modalities)
        self.block3 = CubeMLPBlock(6, last_seq, 32, last_cannel, num_modalities)
