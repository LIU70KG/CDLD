...
def objective(trial):
    ...
    class_weight = trial.suggest_categorical("class_weight", [15.0, 10.0, 5.0, 3.0, 1.0])  # 整数范围
    # shifting_weight = trial.suggest_categorical("shifting_weight", [3.0, 2.0, 1.5, 1.0])  # 离散集合
...
if __name__ == '__main__':
    ...
    study_name = "optimization_center_score_study"
