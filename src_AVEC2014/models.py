...
class MISA_CMDC(nn.Module):
    def __init__(self, config):
        ...
        # self.hidden_sizes = hidden_sizes = [128, int(self.acoustic_size)]
        ...
        # self.fc_CV = nn.Linear(in_features=input_sizes[0], out_features=hidden_sizes[0])
        # self.vrnn1 = rnn(hidden_sizes[0], hidden_sizes[0], bidirectional=True)
